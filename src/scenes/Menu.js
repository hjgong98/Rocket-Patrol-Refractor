class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width / 2, game.config.height / 2, 'Use your mouse to move\nand the left click to fire', menuConfig).setOrigin(0.5)
